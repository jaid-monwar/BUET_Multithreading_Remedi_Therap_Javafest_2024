...
const updateUserAccess = catchAsync(async (req, res) => {
  ...
  res
    .status(httpStatus.OK)
    .send(getSuccessResponse(httpStatus.OK, `User status updated successfully, Status: ${user.access}`, ''));
});
...
const getDoctors = catchAsync(async (req, res) => {
  ...
  const result = await userService.queryUsers(filter, options);
  res.status(httpStatus.OK).send(getSuccessResponse(httpStatus.OK, 'Doctors fetched successfully', result));
});
...
const getPharmacists = catchAsync(async (req, res) => {
  ...
  const result = await userService.queryUsers(filter, options);
  res.status(httpStatus.OK).send(getSuccessResponse(httpStatus.OK, 'Pharmacists fetched successfully', result));
});
