...
const initialPharmacistListState = []
...
function getDoctors(state = initialDoctorListState, action) {
  switch (action.type) {
    case UserActions.END_GET_DOCTORS:
      console.log("===============reducer==========================",action)
      if(action.error){
        throw action.error
      }
...
function getPharmacists(state = initialPharmacistListState, action) {
  switch (action.type) {
    case UserActions.END_GET_PHARMACISTS:
      console.log("===============reducer==========================",action)
      if(action.error){
        throw action.error
      }
